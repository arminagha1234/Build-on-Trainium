...
>
> 1. _TODO: Prerequisites (account, region availability, service quotas)._
> 2. _TODO: Find and reserve a Capacity Block (Console → EC2 → Capacity Reservations → Capacity Blocks for ML)._
> 3. _TODO: Choose instance type (trn2.48xlarge), quantity, and reservation window._
> 4. _TODO: Confirm and pay for the Capacity Block reservation._
> 5. _TODO: Launch instances into the Capacity Block (specify the reservation ID)._
> 6. _TODO: Verify instances are running and reachable._
